...
- Use `bun test --max-concurrency=1 --timeout 20000` for the complete Windows inventory; Windows runners need the higher per-test timeout for cold process and PowerShell starts.
