...
**OG Images**: Auto-generated by CI (`.github/workflows/og-images.yml`) when HTML templates change. CI creates a PR with regenerated PNGs - merge it. For local preview:
