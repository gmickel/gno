...
import {
  qmdAdapterSnapshot as snapshot,
  qmdAdapterTask as task,
  qmdAdapterTools as tools,
  qmdLockForTools as lockForTools,
} from "./qmd-adapter-fixtures";
...
const createHarness = async (
  ...
  const preflight: QmdPreflightResult = {
    lock,
    lockFileSha256: canonicalFingerprint(lock),
