...
Chinese has nine queries because it includes the dedicated rank-7 audit case;
...
| -------- | ------: | -----------: | ------------: | -----------: | ---------------: | ------------: | ----------: | -----------: | ----------: | --------------: | -----------: |
| Chinese  |       9 |       0.1111 |        0.2222 |       0.1270 |           0.1481 |        0.7778 |      0.3611 |       0.4722 |      0.3770 |          0.3981 |       0.5278 |
...
| Ranking        | `zh-q009`                       | The exact Chinese phrase `北辰物流 冷链 🧊` occurs only in the relevant source. Six decoys repeat the component terms out of phrase; production BM25 treats them as a bag of words and ranks the relevant source seventh. |
...
- Index build time: at most `2x` the co-run baseline. The dated reference is
  507.84 ms, or 1015.68 ms at the cap.
- Warm query p95: at most `3x` the co-run baseline and no more than `2 ms`
  absolute increase. The dated ratio ceiling is 2.13 ms from a 0.71 ms baseline.
