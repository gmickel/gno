...
E incluso si no estuvieras usando FastAPI, también podrías escribir tus propias aplicaciones asíncronas con [AnyIO](https://anyio.readthedocs.io/en/stable/) para ser altamente compatibles y obtener sus beneficios (p.ej. _concurrencia estructurada_).
...
### Funciones de _path operation_ { #path-operation-functions }
