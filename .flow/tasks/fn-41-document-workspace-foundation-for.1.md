...
**Files:** `src/serve/routes/api.ts`, `src/serve/public/pages/DocView.tsx`, `src/serve/public/pages/DocumentEditor.tsx`, `src/mcp/tools/get.ts`, `src/sdk/*`, `docs/API.md`, `docs/MCP.md`, `docs/WEB-UI.md`
