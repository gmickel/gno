...
- Tests: bun test:5360pass2skip0fail, bun test test/mcp test/pipeline/verified-ask.test.ts:270pass, bun run lint:check, bun run typecheck, bun run docs:verify:15pass2modelskips, real stdio before/after6cases + verifiedAsk, CLI skill eval47/47; MCP usage47/49; warning probe negative retained
- PRs: