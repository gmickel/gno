...
### Approach
- Add `gno context build` and `gno context verify` over the shared compiler/verifier with deterministic JSON and readable Markdown; validate the frozen schema before emitting or verifying.
