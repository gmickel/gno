...
The task remains in progress. R2/R6 are incomplete: existing exports lack stable note identity and a server-verifiable encrypted note roster. The user's format/privacy decision is pending. Encrypted counts fail closed and note-slug renames do not preserve counts. Full paired performance acceptance, final Flow QA, Fable implementation review, and release remain pending. Do not infer full-spec acceptance from these partial results.
