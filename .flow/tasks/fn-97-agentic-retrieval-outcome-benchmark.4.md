...
**Size:** M
**Files:** `evals/agentic/adapters/lexical.ts`, `evals/agentic/adapters/capsule-prototype.ts`, `evals/agentic/capsule-selection.ts`, `test/evals/agentic/lexical-adapter.test.ts`, `test/evals/agentic/capsule-prototype.test.ts`
