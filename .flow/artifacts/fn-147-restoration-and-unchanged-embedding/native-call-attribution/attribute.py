...
root = repo / '.flow/artifacts/fn-144-native-recovery-and-idle-inference/cuda-3d9c0ec4'
evidence = root / 'evidence'
old = pathlib.Path(__file__).resolve().parent / 'old-snapshots'
...
destination = pathlib.Path(__file__).resolve().parent / 'attribution.reproduced.json'
