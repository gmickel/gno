...
R=Path(__file__).parent; S=R/'source'; B='/home/gordon/.local/share/mise/installs/bun/1.3.14/bin/bun'; G=str(S/'src/index.ts'); C=Path('/tmp/gno-native-baseline-20260905-gmyi58ts/orchid-docs'); E=R/'evidence';E.mkdir(exist_ok=True)
