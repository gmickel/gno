...
ROOT = Path('/home/gordon/work/gno-fn169')
...
FIXTURES = Path('/home/gordon/work/gno-fn169/.flow/artifacts/fn-174-preserve-complementary-capsule-evidence/abstention-probe/cases.json')
...
if (OUTPUT / "reader-manifest.json").exists():
    raise RuntimeError("Refusing to overwrite an existing reader run")
raw = OUTPUT / "draws"
