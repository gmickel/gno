...
| --- | ---------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R0  | Derisking spike — validate Bun detach mechanics (LLM-thread hazard deferred to fn-72.2/.3/.4)  | fn-72.9, fn-72.2, fn-72.3, fn-72.4 | LLM-thread hazard retired in fn-72.2 ad-hoc spike (parent exits ~32ms with node-llama-cpp adapter imported; native threads lazy via ModelManager.getLlama). fn-72.3/.4 still confirm the real serve/daemon subcommands detach cleanly. <!-- Updated by plan-sync: fn-72.2 done summary retired the LLM-thread hazard flagged by the spike --> |
