...
- [inferred] Pre-implementation hook research lives outside version control in the maintainer's local notes directory: see the "hook facts" and "Do NOT" sections of `~/work/gno/notes/fn-171/risk-lessons.md`. It is advisory; live-verify every hook behaviour against the supported harness version before claiming support, and this spec's requirements take precedence.
