...
class RSSConverter {
  async convert(source, options = {}) {
    ...
    try {
      const xmlString = typeof source === "string" ? fs.readFileSync(source, { encoding: "utf-8" }) : source.toString("utf-8");
...
class WikipediaConverter {
  async convert(source, options = {}) {
    ...
    try {
      const htmlContent = typeof source === "string" ? fs.readFileSync(source, { encoding: "utf-8" }) : source.toString("utf-8");
...
class IpynbConverter {
  async convert(source, options = {}) {
    ...
    try {
      const contentStirng = typeof source === "string" ? fs.readFileSync(source, { encoding: "utf-8" }) : source.toString("utf-8");
...
class BingSerpConverter {
  async convert(source, options = {}) {
    ...
    try {
      const htmlContent = typeof source === "string" ? fs.readFileSync(source, { encoding: "utf-8" }) : Buffer.from(source).toString("utf-8");
...
`;
    ...
    if (options.llmModel) {
      const imageBuffer = typeof source === "string" ? fs.readFileSync(source) : Buffer.from(source);
      mdContent += `
# Description:
...
`);
      ...
      const inputStream = typeof source === "string" ? fs.createReadStream(source) : new PassThrough().end(source);
