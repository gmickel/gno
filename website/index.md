...
The Web UI provides a visual dashboard for search, browsing, safe editing, quick switching, linked-note creation, and AI-powered answers. Converted binary sources stay read-only, while markdown/plaintext notes remain editable. Filter by [tags](/features/tags/) extracted from your frontmatter for instant precision.
