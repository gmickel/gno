...
`GNO Desktop Beta` now wraps that same workspace in a thin native shell on
macOS and Windows x64, keeping deep links, singleton handoff, and
desktop-style onboarding aligned with the web experience instead of inventing a
